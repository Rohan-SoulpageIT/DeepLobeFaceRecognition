...
known_faces = [
    ("Obama", os.path.join(os.getcwd(), "sample_images", "obama.jpg")),
    ("Peter", os.path.join(os.getcwd(), "sample_images", "peter.jpg")),
    ("modi", os.path.join(os.getcwd(), "sample_images", "modi.jpg")),
    ("mohit", os.path.join(os.getcwd(), "sample_images", "mohit.jpg")),
    ("purna", os.path.join(os.getcwd(), "sample_images", "purna.jpg")),
    ("rohan", os.path.join(os.getcwd(), "sample_images", "rohan.jpg")),
    ("sunder", os.path.join(os.getcwd(), "sample_images", "sunder.jpg")),
    ("shubham", os.path.join(os.getcwd(), "sample_images", "sunder.jpg")),
]
